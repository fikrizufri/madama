...
<head>
    ...
    <title>Admin Manajer | CV. Green Nusa Computindo</title>
...
<div class="left-aside desktop-view">
    <div class="aside-branding">
        <a href="{{ url('/') }}" class="iconic-logo"><img src="{{ asset('admin/images/logo-iconic.png') }}" alt="SMS Manager">
        </a>
        <a href="{{ url('/') }}" class="large-logo"><img src="{{ asset('admin/images/logo-large.png') }}" alt="SMS Manager">
        ...
        <div class="row">
            ...
            <div class="col-md-6 responsive-fix">
                <div class="top-aside-right">
                        ...
                        <ul>
                            <li class="dropdown">
                                <a data-toggle="dropdown" href="#" class="clearfix dropdown-toggle waves-effect waves-block waves-classic">
                                    <span class="user-info">TEst
                                    <cite>gmail.com</cite>
                                    </span>
                                    <span class="user-thumb"><img src="{{ asset('admin/images/avatar/jaman.jpg') }}" alt="image"></span>
                                </a>
                                <ul role="menu" class="dropdown-menu fadeInUp">
                                    ...
                                    <a href="{{ url('/logout') }}" onclick="event.preventDefault();
                                        ...
                                        <span class="user-nav-icon"><i class="fa fa-lock"></i></span><span class="user-nav-label">Logout</span>
                                    </a>
                    ...
                    <span class="rightbar-action waves-effect"><img src="{{ asset('admin/images/logo-iconic.png') }}" alt="SMS Manager"></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="footer-left">
                    <span>&copy; 2017 &brvbar;&nbsp;<a href="#">GreenNusa</a></span>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="footer-right">
                    <span class="footer-meta">Crafted with&nbsp;<i class="fa fa-heart"></i>&nbsp;by<a href="#">alg.field</a>&Oslash;<sub>.2</sub></span>
                </div>
            </div>
        </div>
    </div>
